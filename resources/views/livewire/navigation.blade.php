    <header class="bg-orange-400 sticky top-0" x-data="dropdown()">
        <div class="container flex items-center h-16 justify-between md:justify-start">
            <a :class="{'bg-opacity-100 text-orange-500' : open}" x-on:click="show()"
                ...
                bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-full">
        ...
        <nav id="navigation-menu" x-show="open" :class="{'block': open, 'hidden': !open}"
            ...
            <div class="bg-white h-full overflow-y-auto">
                <div class="container bg-orange-400 py-3 ">
                    @livewire('search')
                </div>
                <ul>
                    @foreach ($categories as $category)
                ...
                <p class="text-gray-200 bg-cyan-500 hover:bg-cyan-600 hover:text-white px-6">USUARIOS</p>
